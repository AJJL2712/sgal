...
import { FiCalendar, FiLogOut, FiGrid } from "react-icons/fi";
  ...
  const modulos = [
    {
      ...
      descripcion: "Consulta disponibilidad y reserva aulas o laboratorios para tus clases.",
      uc: "UC004",
  ...
  return (
    ...
    >
      ...
      <div className="px-8 py-10 max-w-5xl mx-auto">
        <div className="mb-8">
          <h2 className="text-white text-2xl font-semibold">Panel Docente</h2>
          <p className="text-sm mt-1" style={{ color: "#8b7aa8" }}>
            Administra tus reservas de aulas y laboratorios.
          </p>
        </div>
